...
function RPListFrame_OnShow()
	...
	getglobal(this:GetName().."CheckButtonGOBLIN"):SetChecked( PlaceInArray( RPCONFIG.traits, "GOBLIN" ) )
	...
	getglobal(this:GetName().."CheckButtonHIGHELF"):SetChecked( PlaceInArray( RPCONFIG.traits, "HIGHELF" ) )
